...
<section class="h-hi-street">
		<div class="container">
			...
			<div class="row pt-4 pb-3 py-md-5">
				<div class="col-md-2 col-1 pr-0">
					<img src="<?php echo get_template_directory_uri(); ?>/img/quote-left.png" alt="" class="img-fluid q-img">
				</div>
				<div class="col-md-8 col-10">
					<h2 class="main-color text-center font-weight-bold mb-md-4"><?php echo $mytestimonials->post_title; ?></h2> 
